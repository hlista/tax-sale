defmodule TaxSale.Search.Counties.LaPorte do
  require Logger
  alias PG.Context
  @low_tax_info_parcel_number_url "https://lowtaxinfo.com/lti-api/LowMobileTaxData.svc/api/PropertySearch?CorpCode=LAC&parcel=PARCEL_NUMBER&page_number=0"
  @low_tax_info_dup_url "https://lowtaxinfo.com/lti-api/LowMobileTaxData.svc/api/GetParcel?CorpCode=LAC&dup=DUP_NUMBER&PayYear=2024"
